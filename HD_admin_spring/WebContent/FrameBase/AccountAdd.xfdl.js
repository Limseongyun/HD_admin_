(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Combo("Combo00","256","420","122","43",null,null,null,null,null,null,this.Tab00.Product_tab.form);
            obj.set_taborder("6");
        ...
        this.qua_div_qualification_list = function(obj,e)
        {
        	...
        	var url = "http://192.168.25.10:8100/HD_admin_spring/qualification_list";
        	var reqDs = "";
        ...
        this.qua_div_qua_delete_onclick = function(obj,e)
        {
        	...
        	var url = "http://192.168.25.10:8100//HD_admin_spring/qualification_delete?qua_code="+del_qua_codev;
        	var reqDs = "";
        	var respDs="";
        	var args = "";
        	var callback ="received";
        ...
        this.qua_div_qua_insert_onclick = function(obj,e)
        {
        	...
        	var url = "http://192.168.25.10:8100//HD_admin_spring/qualification_insert?qua_name="+qua_namev+"&qua_maxage="+qua_maxagev+"&qua_minage="+qua_minagev+"&qua_minmoney="+qua_minmoneyv+"&qua_maxmoney="+qua_maxmoneyv+"&qua_minperiod="+qua_minperiodv+"&qua_maxperiod="+qua_maxperiodv;
        	var reqDs = "";
        	var respDs="";
        	var args = "";
        	var callback ="received";
        ...
        this.Tab00_Saving_tab_saving_inquire_onclick = function(obj,e)
        {
        	...
        	//alert(sav_test)
        	var id="savinglist";
        	var url = "http://192.168.25.10:8100/HD_admin_spring/saving_list";
        	var reqDs = "";
        ...
        this.Tab00_Saving_tab_saving_add_btn_onclick = function(obj,e)
        {
        	...
        	var url = "http://192.168.25.10:8100//HD_admin_spring/saving_insert?sav_name="+sav_namev+"&sav_interestrate="+sav_interestratev+"&sav_online="+sav_onlinev+"&shas_code="+shas_codev+"&qua_code="+qua_codev;
        	var reqDs = "";
        	var respDs="";
        	var args = "";
        	var callback ="received";
        ...
        this.Tab00_Saving_tab_saving_del_Btn_onclick = function(obj,e)
        {
        	...
        	var url = "http://192.168.25.10:8100//HD_admin_spring/saving_delete?sav_code="+del_saving_codev;
        	var reqDs = "";
        	var respDs="";
        	var args = "";
        	var callback ="received";
        ...
        this.Tab00_Saving_tab_shas_div_shas_inquire_onclick = function(obj,e)
        {
        	...
        	var url = "http://192.168.25.10:8100/HD_admin_spring/shared_saving_list";
        	var reqDs = "";
        ...
        this.Tab00_Saving_tab_shas_div_shas_add_btn_onclick = function(obj,e)
        {
        	...
        	var url = "http://192.168.25.10:8100//HD_admin_spring/shared_saving_insert?shas_count="+shas_countv+"&shas_master="+shas_masterv;
        	var reqDs = "";
        	var respDs="";
        	var args = "";
        	var callback ="received";
        ...
        this.Tab00_Saving_tab_shas_div_shas_del_btn_onclick = function(obj,e)
        {
        	...
        	var url = "http://192.168.25.10:8100//HD_admin_spring/shared_saving_delete?shas_code="+del_shas_codev;
        	var reqDs = "";
        	var respDs="";
        	var args = "";
        	var callback ="received";
